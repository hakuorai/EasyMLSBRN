...
def parse_args():
    ...
    parser.add_argument(
        "dataroot", help="root to test dataset"
    )
    parser.add_argument(
...
class EvaluationParameters:
    def __init__(self, city, model, pkl, csv_root, data_root):
        # flags
        self.with_vis = True
        ...
        # Default dataset
        # dataset file
        self.anno_file = f"{self.dataset_root}/coco/bonai_test_5.json"
        self.test_image_dir = f"{self.dataset_root}/images"
        # csv ground truth files
        self.gt_roof_csv_file = f"{self.dataset_root}/csv/shanghai_xian_v3_merge_val_roof_crop1024_gt_minarea500.csv"
        self.gt_footprint_csv_file = f"{self.dataset_root}/csv/shanghai_xian_v3_merge_val_footprint_crop1024_gt_minarea500.csv"
...
if __name__ == "__main__":
    ...
    eval_parameters = EvaluationParameters(
        city=args.city, 
        model=args.model, 
        pkl=args.pkl_file_path, 
        csv_root=args.csv_save_path,
