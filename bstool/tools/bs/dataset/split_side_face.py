...
class SplitImage():
    def __init__(self,
        ...
        self.edge_image_dir = f'./data/{core_dataset_name}/{src_version}/{city}/{sub_fold}/pixel_anno_v2'
        ...
        self.label_save_dir = f'./data/{core_dataset_name}/{dst_version}/{city}/side_face'
    ...
    def split_image(self, image_file):
        ...
        if subimages is None:
            image_file = bstool.generate_image(2028, 2048, (0, 0, 0))
            subimages = bstool.split_image(image_file, 
                                        subsize=self.subimage_size, 
                                        gap=self.gap)
        ...
        for subimage_coordinate in subimage_coordinates:
            ...
            for subclass, converted_class in zip([2, 4], [1, 1]):
