# -*- encoding: utf-8 -*-
'''
@File    :   select_validation_images_shanghai_1114.py
@Time    :   2020/12/30 22:32:28
@Author  :   Jinwang Wang
@Version :   1.0
@Contact :   jwwangchn@163.com
@License :   (C)Copyright 2017-2020
@Desc    :   挑选 shanghai 的验证集图像 (20201114 版本)
'''
...
def parse_args():
    ...
    parser.add_argument(
        '--score_threshold',
        type=int,
        default=3326, # 17225 for 20201028 generation, 13608 for 20201027 generation, 9360 and 0 for 20201027 highset generation
...
if __name__ == '__main__':
    ...
    training_csv_file = f'./data/buildchange/public/misc/nooverlap/validation_dataset_info_{version}_shanghai_20201114.csv'
    training_imageset_file = f'./data/buildchange/public/misc/nooverlap/validation_imageset_file_{version}_shanghai_20201114.txt'
    ...
    if len(training_info) > 0:
        src_root_image_dir = './data/buildchange/v2/shanghai/images'
        src_root_label_dir = './data/buildchange/v2/shanghai/labels'
        dst_root_image_dir = './data/buildchange/public/{}/shanghai_fine_20201114/images'
        dst_root_label_dir = './data/buildchange/public/{}/shanghai_fine_20201114/labels'
