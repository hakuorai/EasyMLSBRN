# -*- encoding: utf-8 -*-
'''
@File    :   merge_shapefile_val_xian.py
@Time    :   2020/12/30 22:40:25
@Author  :   Jinwang Wang
@Version :   1.0
...
class MergeShapefile():
    def __init__(self,
                ...
                num_processor=8):
        self.image_path = f'./data/{core_dataset_name}/{src_version}/{city}/{sub_fold}/images'
        self.anno_path = f'./data/{core_dataset_name}/{src_version}/{city}/{sub_fold}/roof_shp_pixel'
        self.geo_path = f'./data/{core_dataset_name}/{src_version}/{city}/{sub_fold}/images'

        self.merged_shapefile_save_path = f'./data/{core_dataset_name}/{src_version}/{city}/{sub_fold}/merged_shp'
